...
class SJCenterFlowLayout: UICollectionViewFlowLayout {
    ...
    var spacingMode = SJCenterFlowLayoutSpacingMode.fixed(spacing: 58)
    var animationMode = SJCenterFlowLayoutAnimation.scale(sideItemScale: 0.6, sideItemAlpha: 0.6, sideItemShift: 0.0)
